function showCard(index) {
  const cards = document.querySelectorAll('#prmd .card');
  const buttons = document.querySelectorAll('#prmd .tab-btn');
  const planNames = ['basic', 'grow', 'advanced', 'plus'];
...
function switchPlan(plan) {
  const tabs = document.querySelectorAll('#prmd .mobile-tabs button');
